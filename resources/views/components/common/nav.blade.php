<nav class="bg-violet-50 w-full z-20 top-0 left-0 fixed mb-3">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div class="flex md:order-2">
        <button type="button" class="text-white bg-violet-700 font-bold hover:bg-violet-800 focus:ring-4 focus:outline-none focus:ring-violet-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0">Go to Dashboard</button>
